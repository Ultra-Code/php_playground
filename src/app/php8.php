...
class php8
{
    ...
    public function __construct(public readonly string  $cannot_modify, private readonly \Iterator&\ArrayAccess $some_type, protected $typpe = new $type())
    {
    }
    ...
    public function array_list_fns()
    {
    ...
    public function firstclasscallable()
    {
